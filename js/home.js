...
$(document).on('ready',function(event) {
	...
	**/
						...
						$.ajax({
							...
							success: function(response){
								...
								if(response > 0){
									...
									var radio_id1 = response + '_a';
									var radio_id2 = response + '_b';
									var enable = "<td style='text-align:center;'><div id="+ response +" class='rad_class_status'><input type='radio' id="+ radio_id1 +" name="+ response +" value='1' checked><label for="+ radio_id1 +">Enable</label><input type='radio' id="+ radio_id2 +" name="+ response +" value='0'><label for="+ radio_id2 +">Disable</label></div></td>";
									var disable = "<td style='text-align:center;'><div id="+ response +" class='rad_class_status'><input type='radio' id="+ radio_id1 +" name="+ response +" value='1'><label for="+ radio_id1 +">Enable</label><input type='radio' id="+ radio_id2 +" name="+ response +" value='0' checked><label for="+ radio_id2 +">Disable</label></div></td>";
									...
									var add_tbl_row = "<tr class= "+ odd_even +" style='display: table-row'>";
										...
										add_tbl_row += "<td style='text-align:center;' colspan='2'><input type='checkbox' id="+ response +" name='delete' /></td>";
										add_tbl_row += "</tr>";
	...
	// update class status //
	$('a#btn_save_updates').unbind().click(function(){
		var update_val = $("#class_list").serializeArray();
		$.ajax({
			type: 'POST',
			url: 'controller.php',
			data: {'form':update_val,'function_name':'update_class'},
			success: function(response){
